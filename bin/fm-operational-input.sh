...
FM_OPERATIONAL_KINDS='session-start watcher turn-end-guard herdr-guard away-supervisor launch-brief'
...
Current construction kinds:
  session-start watcher turn-end-guard herdr-guard away-supervisor from-firstmate launch-brief
